    ...
    <form method="POST" action={{ route('user.profile.update', ['id' => $user->id]) }}  enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-12 mx-auto mb-4 d-flex justify-content-center bg-dark rounded">
                ...
                <div class="col-3 my-auto">
                    <label for="change-photo" class="btn btn-primary btn-sm">Change Photo</label>
                    <input id="change-photo" type="file" hidden name="photo">
                </div>
            </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="username" class="form-control bg-black text-white"
