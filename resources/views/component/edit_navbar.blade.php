<div class="col-lg-3 col-md-3 col-sm-3 border-end border-start d-flex flex-column align-items-center">
    <div class="row">
    ...
    <div class="row pb-4 ">
        <div class="col rounded link" data-form="edit_profile" data-user-id="{{$user->id}}">
            <div class="d-flex mx-auto my-3 m-lg-3">
                <div class="col-1">
        ...
        <div class="col rounded link" data-form="email_change" data-user-id="{{$user->id}}">
            <div class="d-flex mx-auto my-3 m-lg-3">
                <div class="col-1">
                    ...
                    <path fill="#ffffff" d="M0 3v18h24v-18h-24zm6.623 7.929l-4.623 5.712v-9.458l4.623 3.746zm-4.141-5.929h19.035l-9.517 7.713-9.518-7.713zm5.694 7.188l3.824 3.099 3.83-3.104 5.612 6.817h-18.779l5.513-6.812zm9.208-1.264l4.616-3.741v9.348l-4.616-5.607z"/>
                </svg> 
                </div>
                <div class="col ps-3 d-none d-md-block">
