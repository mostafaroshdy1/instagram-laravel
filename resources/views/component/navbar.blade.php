...
<div class="row">
    <div class="col ps-4 pt-3 pb-5">
        <a href="" class="fs-1" style="color: white">
...
<div class="row">
    <div class="row">
        <div class="col ps-4 pt-1 pb-3 ">
            <a class="text-decoration-none" href="index.html">
                <div class="row">
                    <div class="col-1 text-white pe-4">
                        <i class="material-icons-outlined fs-2 ">home</i>
                    </div>
                    <div class="col text-white ps-4 pt-1 fs-6  ">
                        <p>Home</p>
                    </div>
                </div>
            </a>
    ...
    <div class="row">
        <div class="col ps-4 pt-1 pb-3 ">
            <a class="text-decoration-none" href="index.html">
                <div class="row">
                    <div class="col-1 text-white pe-4">
                        <i class="material-icons-outlined fs-2 ">explore</i>
                    </div>
                    <div class="col text-white ps-4 pt-1 fs-6  ">
                        <p>Explore</p>
                    </div>
    ...
    <div class="row">
        <div class="col ps-4 pt-1 pb-3 ">
            <a class="text-decoration-none" href="index.html">
                <div class="row">
                    <div class="col-1 text-white pe-4">
                        <i class="material-icons-outlined fs-2 ">movie</i>
                    </div>
                    <div class="col text-white ps-4 pt-1 fs-6  ">
                        <p>Reels</p>
                    </div>
    ...
    <div class="row">
        <div class="col ps-4 pt-1 pb-3 ">
            <a class="text-decoration-none" href="index.html">
                <div class="row">
                    <div class="col-1 text-white pe-4">
                        <i class="material-icons-outlined fs-2 ">chat_bubble_outline</i>
                    </div>
                    <div class="col text-white ps-4 pt-1 fs-6  ">
                        <p>Messages</p>
                    </div>
    ...
    <div class="row">
        <div class="col ps-4 pt-1 pb-3 ">
            <a class="text-decoration-none" href="index.html">
                <div class="row">
                    <div class="col-1 text-white pe-4">
                        <i class="material-icons-outlined fs-2 ">add_circle_outline</i>
                    </div>
                    <div class="col text-white ps-4 pt-1 fs-6  ">
                        <p>Create</p>
                    </div>
        ...
        <div class="col ps-4 pt-1 pb-3 ">
            <a class="text-decoration-none" href="index.html">
                <div class="row">
                    <div class="col-1 text-white pe-4">
                        {{-- <i class="material-icons-outlined fs-2 ">explore</i> --}}
                        <img src="{{asset('homePage/images/profile_img.jpg')}}" alt="Profile Picture" class="profile-picture-nav rounded-circle">
                    </div>
                    <div class="col text-white ps-4 pt-1 fs-6  ">
                        <p>Explore</p>
                    </div>
    ...
    <div class="row">
        <div class="col ps-4 pt-1 pb-3">
            <a class="text-decoration-none" href="index.html">
                <div class="row">
                    <div class="col-1 text-white pe-4">
                        <i class="material-icons-outlined fs-2 ">menu</i>
                    </div>
                    <div class="col text-white ps-4 pt-1 fs-6  ">
                        <p>More</p>
                    </div>
