                        ...
                        <ul>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <svg class="me-3" aria-label="Home" class="x1lliihq x1n2onr6 x5n08af "
                                        ...
                                        <path d="M7.41 17H14a1 1 0 0 0 0-2H7.41l1.3-1.29a1 1 0 0 0-1.42-1.42l-3 3a1 1 0 0 0-.21.33 1 1 0 0 0 0 .76 1 1 0 0 0 .21.33l3 3a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM20 17a1 1 0 0 0 0-2 1 1 0 1 0 0 2z" fill="#ffffff"/>
