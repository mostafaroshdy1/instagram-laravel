...
<div class="nav_menu ">
    ...
    <div class="nav_bottom">
        <a href="{{ asset('homePage/home.html') }}"><img src="{{ asset('homePage/images/accueil.png') }}"></a>
        <a href="{{ asset('homePage/explore.html') }}"><img src="{{ asset('homePage/images/compass.png') }}"></a>
        <a href="{{ asset('homePage/reels.html') }}"><img src="{{ asset('homePage/images/video.png') }}"></a>
